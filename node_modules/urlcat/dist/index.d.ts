...
export declare type UrlCatConfiguration = Partial<Pick<IStringifyOptions, 'arrayFormat'> & {
 ...
 * ```
 */
export declare function configure(rootConfig: UrlCatConfiguration): (baseUrlOrTemplate: string, pathTemplateOrParams: string | ParamMap, maybeParams?: ParamMap, config?: UrlCatConfiguration) => string;
/**
 ...
 * ```
 */
export declare function query(params: ParamMap, config?: UrlCatConfiguration): string;
/**
